(function() {
  var ConnectionReceiver, GenericReceiver, MAP, ResponseReceiver, Session, SockJSConnection, Transport, closeFrame, stream, uuid;
  ...
  SockJSConnection = (function() {
    __extends(SockJSConnection, stream.Stream);
  ...
  Session = (function() {
    function Session(session_id, server) {
      ...
      this.emit_open = __bind(function() {
        this.emit_open = null;
        return server.emit('connection', this.connection);
      }, this);
    }
