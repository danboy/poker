(function() {
  ...
  exports.app = {
    ...
    xhr_poll: function(req, res, _, next_filter) {
      ...
      res.writeHead(200);
      session = transport.Session.bySessionIdOrNew(req.session, this);
      session.register(new XhrPollingReceiver(res, this.options));
      return true;
    },
    xhr_streaming: function(req, res, _, next_filter) {
      ...
      session = transport.Session.bySessionIdOrNew(req.session, this);
      session.register(new XhrStreamingReceiver(res, this.options));
      return true;
    }
  };
}).call(this);
