(function() {
  ...
  generate_dispatcher = function(options) {
    ...
    return maybe_add_transport('websocket', [['GET', t('/websocket'), ['websocket']]]);
  };
  Listener = (function() {
